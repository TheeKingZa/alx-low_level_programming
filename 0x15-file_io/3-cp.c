 ...
 *
 * @file: Bufffer file storing chars for.
 *
...
buffer = malloc(sixeof(char) * 1024);

if (buffer == NULL)
{
dprintf(STDERR_FILENO, "Error: Cants write to %s\n", file);
exit(99);
}
 ...
 * Return: 0 on success.
 *
 * Description: if argument count [argc] is incorrect           -       exit code 97.
